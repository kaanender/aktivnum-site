...
export default function AktivnumSite() {
  ...
  <div className="max-w-7xl mx-auto h-14 px-6 flex items-center justify-between relative"> 
    ...
    <nav className="absolute left-1/2 -translate-x-1/2 flex gap-6 text-sm text-neutral-900"> 
      ...
      <Link to="/access-code">Cours</Link>
      <Link to="/akademy" className="hover:text-neutral-900">Nos fromations</Link>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-[1.2fr_0.9fr] gap-10 items-center">
          <div>
            ...
            <p className="mt-6 text-neutral-700 max-w-2xl">
              Support professionnel — Sécurisation, optimisation et assistance informatique pour particuliers & entreprises. <span className="font-medium text-neutral-900"></span> 
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl border border-neutral-200 hover:border-[#ff914d] transition-colors p-6 bg-white hover:bg-neutral-50 text-neutral-900 transition-colors hover:bg-[#e57d3c] transition-colors">
              ...
              <a
  href="https://t.me/TON_TELEGRAM?text=Bonjour,+je+veux+recevoir+le+pack+anti-arnaque"
  target="_blank"
  rel="noreferrer"
  className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#ff914d] text-white hover:opacity-90 transition"
>
  Recevoir le guide sur Telegram
</a>
            </div>
          </div>
        </div>
...
{/* CONTACT */}
      <section id="contact" className="py-16 bg-white hover:bg-neutral-50 text-neutral-900 transition-colors hover:bg-[#e57d3c] transition-colors">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="rounded-2xl border border-neutral-200 hover:border-[#ff914d] transition-colors bg-neutral-50 hover:border-[#ff914d] transition-colors p-6">
            <h3 className="text-lg font-semibold">Notre mission & notre rôle</h3>
            <p className="text-sm text-neutral-900 mt-2"></p>
            <p className="text-xs text-neutral-700 mt-3">AKTIVNUM est une entreprise fondée pour répondre à deux enjeux majeurs du secteur numérique : la protection contre la montée des cyberattaques et la maintenance fiable des infrastructures informatiques (serveurs, postes, réseaux). L’entreprise assure également des prestations de réparation et de support technique. En parallèle, AKTIVNUM développe un volet formation destiné aux étudiants et débutants souhaitant intégrer le domaine, afin de leur offrir une immersion structurée dans les pratiques professionnelles actuelles.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-10 border border-neutral-200 hover:border-[#ff914d] transition-colors-t bg-neutral-50">
        <div className="max-w-7xl mx-auto px-6 text-sm text-neutral-700 flex flex-col md:flex-row items-center justify-between gap-4">
          <p>© {new Date().getFullYear()} AKTIVNUM </p>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-4 text-xs text-neutral-700">
          <p>Ce site est certifié et conforme aux normes en vigueur — ActivNium ©</p>
        </div>
      </footer>
    </div>
  );
